                    ...
                    <ul class="space-y-2">
                        ...
                        {{-- <li>
                            <a href="{{ route('admin.categories.index') }}" class="flex items-center text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2">
                                <i class="ph ph-folders mr-3 text-lg"></i>
                                <span>Categories</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.authors.index') }}" class="flex items-center text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2">
                                <i class="ph ph-user-list mr-3 text-lg"></i>
                                <span>Authors</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.publishers.index') }}" class="flex items-center text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2">
