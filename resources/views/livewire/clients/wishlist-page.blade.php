<div>
    ...
    <section class="cart py-80">
        <div class="container container-lg">
            <div class="row g-4">
                <div class="xl:w-11/12  flex-grow-0 flex-shrink-0 basis-auto">
                            ...
                            <table class="table rounded-8 overflow-hidden">
                                <thead>
                                    <tr class="border-b border-neutral-100">
                                        <th class="h6 mb-0 text-lg font-[700] px-40 py-32 border-r border-neutral-100">Delete
                                        </th>
                                        <th class="h6 mb-0 text-lg font-[700] px-40 py-32 border-r border-neutral-100">
                                            Product Name</th>
                                        <th class="h6 mb-0 text-lg font-[700] px-40 py-32 border-r border-neutral-100">Unit
                                            Price</th>
                                        <th class="h6 mb-0 text-lg font-[700] px-40 py-32 border-r border-neutral-100">Stock
                                            Status</th>
                                        <th class="h6 mb-0 text-lg font-[700] px-40 py-32"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="">
                                        <td class="px-40 py-32 border-r border-neutral-100">
                                            <button type="button"
                                                ...
                                                <div class="table-product__content text-start">
                                                    ...
                                                    <div class="flex items-center gap-16 mb-16">
                                                        <div class="flex items-center gap-6">
                                                            <span class="text-md font-[500] text-warning-600 flex"><i
                                                                    class="ph-fill ph-star"></i></span>
                                                            <span class="text-md font-[600] text-gray-900">4.8</span>
                                                        </div>
                                                        <span class="text-sm font-[500] text-gray-200">|</span>
                                                        <span class="text-neutral-600 text-sm">128 Reviews</span>
                                                    </div>
                                                    <div class="flex items-center gap-16">
                                                        <a href="cart.html"
                                                            class="product-card__cart btn bg-gray-50 text-heading text-sm hover-bg-main-600 hover-text-white py-7 px-8 rounded-8 flex items-center justify-center gap-8 font-[500]">
                                                            Camera
                                                        </a>
                                                        <a href="cart.html"
                                                            class="product-card__cart btn bg-gray-50 text-heading text-sm hover-bg-main-600 hover-text-white py-7 px-8 rounded-8 flex items-center justify-center gap-8 font-[500]">
                                        ...
                                        <td class="px-40 py-32 border-r border-neutral-100">
                                            <span class="text-lg h6 mb-0 font-[600]">$125.00</span>
                                        </td>
                                        <td class="px-40 py-32 border-r border-neutral-100">
                                            <span class="text-lg h6 mb-0 font-[600]">In Stock</span>
                                        </td>
                                        <td class="px-40 py-32">
                                            <a href="cart.html" class="btn btn-main-two rounded-8 px-64">
