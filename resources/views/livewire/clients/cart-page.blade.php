                    ...
                    <div class="cart-table border border-gray-100 rounded-8 px-40 py-48">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-product flex items-center gap-24">
                                                <a href="product-details-two.html"
                                                    class="table-product__thumb border border-gray-100 rounded-8 flex items-center justify-center ">
                                                    <img src="/images/thumbs/product-two-img4.png" alt="Image">
                                                </a>
                                                <div class="table-product__content text-start">
                                                    <h6 class="title text-lg font-[600] mb-8">
                                                        <a href="product-details.html" class="link text-line-2"
                        ...
                        <div class="flex-between flex-wrap gap-16 mt-16">
                            <div class="flex items-center gap-16">
                                ...
                                <button type="submit" class="btn btn-main py-18 w-full rounded-8">Apply Coupon</button>
                            </div>
                    ...
                    <div class="cart-sidebar border border-gray-100 rounded-8 px-24 py-40">
                        ...
                        <div class="bg-color-three rounded-8 p-24">
                            <div class="mb-32 flex-between gap-8">
                                ...
                                <span class="text-gray-900 font-[600]">$250.00</span>
                            </div>
                            <div class="mb-32 flex-between gap-8">
                                <span class="text-gray-900 font-heading-two">Extimated Delivery</span>
                                <span class="text-gray-900 font-[600]">Free</span>
                            </div>
                            <div class="mb-0 flex-between gap-8">
                                <span class="text-gray-900 font-heading-two">Extimated Taxs</span>
                                <span class="text-gray-900 font-[600]">USD 10.00</span>
                            </div>
                        </div>
                        <div class="bg-color-three rounded-8 p-24 mt-24">
                            <div class="flex-between gap-8">
                                <span class="text-gray-900 text-xl font-[600]">Total</span>
                                <span class="text-gray-900 text-xl font-[600]">$250.00</span>
                            </div>
                        </div>
                        <a href="checkout.html" class="btn btn-main mt-40 py-18 w-full rounded-8">Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>
