        ...
        <div class="container container-lg ">
            <div class="border border-gray-100 rounded-8 px-30 py-20 mb-40">
                <span class="">Have a coupon? <a href="cart.html"
                        class="font-[600] text-gray-900 hover-text-decoration-underline hover-text-main-600">Click here to
                ...
                <div class="2xl:w-9/12  flex-grow-0 flex-shrink-0 basis-auto xl:w-8/12 ">
                    <form action="#" class="pe-xl-5">
                        <div class="row g-3">
                            ...
                            <div class="w-full  flex-grow-0 flex-shrink-0 basis-auto">
                                <input type="text" class="common-input border-gray-100" placeholder="United states (US)">
                            </div>
                            <div class="w-full  flex-grow-0 flex-shrink-0 basis-auto">
                ...
                <div class="2xl:w-3/12  flex-grow-0 flex-shrink-0 basis-auto xl:w-4/12 ">
                    <div class="checkout-sidebar">
                        <div class="bg-color-three rounded-8 p-24 text-center">
                            <span class="text-gray-900 text-xl font-[600]">Your Orders</span>
                        </div>
                        <div class="border border-gray-100 rounded-8 px-24 py-40 mt-24">
                            <div class="mb-32 pb-32 border-b border-gray-100 flex-between gap-8">
                                <span class="text-gray-900 font-[500] text-xl font-heading-two">Product</span>
                                <span class="text-gray-900 font-[500] text-xl font-heading-two">Subtotal</span>
                            </div>
                            <div class="flex-between gap-24 mb-32">
                                <div class="flex items-center gap-12">
                                    <span class="text-gray-900 font-normal text-md font-heading-two w-144">HP Chromebook
                                        With Intel Celeron</span>
                                    <span class="text-gray-900 font-normal text-md font-heading-two"><i
                                            class="ph-bold ph-x"></i></span>
                                    <span class="text-gray-900 font-[600] text-md font-heading-two">1</span>
                                </div>
                                <span class="text-gray-900 font-[700] text-md font-heading-two">$250.00</span>
                            </div>
                            <div class="flex-between gap-24 mb-32">
                                <div class="flex items-center gap-12">
                                    <span class="text-gray-900 font-normal text-md font-heading-two w-144">HP Chromebook
                            ...
                            <div class="border-t border-gray-100 pt-30  mt-30">
                                <div class="mb-32 flex-between gap-8">
                                    <span class="text-gray-900 font-heading-two text-xl font-[600]">Subtotal</span>
                                    <span class="text-gray-900 font-heading-two text-md font-[700]">$859.00</span>
                                </div>
                                <div class="mb-0 flex-between gap-8">
                                    <span class="text-gray-900 font-heading-two text-xl font-[600]">Total</span>
                                    <span class="text-gray-900 font-heading-two text-md font-[700]">$859.00</span>
                                </div>
                            </div>
                        </div>
                        <div class="mt-32">
                            <div class="payment-item">
                                <div class="form-check common-check common-radio py-16 mb-0">
                                    <input class="form-check-input" type="radio" name="payment" id="payment1"
                                        checked>
                                    <label class="form-check-label font-[600] text-neutral-600" for="payment1">Direct Bank
                                        transfer</label>
                                </div>
                            ...
                            <div class="payment-item">
                                <div class="form-check common-check common-radio py-16 mb-0">
                                    ...
                                    <label class="form-check-label font-[600] text-neutral-600" for="payment2">Check
                                        payments</label>
                                </div>
                                <div class="payment-item__content px-16 py-24 rounded-8 bg-main-50 relative">
                                    <p class="text-gray-800">Make your payment directly into our bank account. Please use
                            ...
                            <div class="payment-item">
                                <div class="form-check common-check common-radio py-16 mb-0">
                                    ...
                                    <label class="form-check-label font-[600] text-neutral-600" for="payment3">Cash on
                                        delivery</label>
                                </div>
                                <div class="payment-item__content px-16 py-24 rounded-8 bg-main-50 relative">
                                    <p class="text-gray-800">Make your payment directly into our bank account. Please use
                        ...
                        <a href="checkout.html" class="btn btn-main mt-40 py-18 w-full rounded-8 mt-56 text-center">Place
                            Order</a>
                    </div>
                </div>
            </div>
