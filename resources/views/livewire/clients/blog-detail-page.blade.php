        ...
        <div class="container container-lg">
            <div class="row g-5">
                <div class="xl:w-8/12  flex-grow-0 flex-shrink-0 basis-auto pe-xl-4">
                    <div class="blog-item-wrapper">
                        <div class="blog-item">
                            ...
                            <div class="blog-item__content mt-24">
                                ...
                                <p class="text-gray-700 pb-24 mb-24 border-b border-gray-100">Re-engagement — objectives. As
                                    ...
                                    and eliminate...</p>
                                <div class="flex items-center flex-wrap gap-24">
                    ...
                    <div class="mt-48">
                        <p class="text-gray-700 mb-24">A great commerce experience cannot be distilled to a single number.
                    ...
                    <div class="mt-48">
                        ...
                        <div class="row g-4">
                            <div class="md:w-6/12  flex-grow-0 flex-shrink-0 basis-auto">
                                <ul>
                                    <li class="flex items-start gap-8 mb-20">
                                        <span class="text-xl flex flex-shrink-0"><i class="ph ph-check"></i></span>
                                        <span class="text-gray-700 flex-grow">A great commerce experience cannot be
                                    ...
                                    <li class="flex items-start gap-8 mb-0">
                                        <span class="text-xl flex flex-shrink-0"><i class="ph ph-check"></i></span>
                                        <span class="text-gray-700 flex-grow">A great commerce experience cannot be
                                            distilled to a single number. </span>
                                    </li>
                    ...
                    <div class="mt-48">
                        <div class="rounded-16 bg-main-50 p-24">
                            <span
                                class="w-48 h-48 bg-main-600 text-white flex items-center justify-center rounded-[50%] mb-24 text-2xl"><i
                            ...
                            <div class="flex items-center gap-8">
                                <span class="text-15 font-[500] text-neutral-600 flex"><i
                    ...
                    <div class="my-48">
                        <span class="border-b border-gray-100 block"></span>
                    </div>
                    <div class="my-48 flex-between md:flex-nowrap flex-wrap gap-24">
                        <div class="">
                            <button type="button"
                                class="mb-20 h6 text-gray-500 text-lg font-normal hover-text-main-600">Previous
                                Post</button>
                            <h6 class="text-lg mb-0">
                                <a href="blog-details.html" class="">A great commerce experience cannot be distilled
                                    to a single number. </a>
                            </h6>
                        </div>
                        <div class="text-end">
                            <button type="button"
                                class="mb-20 h6 text-gray-500 text-lg font-normal hover-text-main-600">Next</button>
                            <h6 class="text-lg mb-0">
                                <a href="blog-details.html" class="">A great commerce experience cannot be distilled
                                    to a single number. </a>
                            </h6>
                    ...
                    <div class="my-48">
                        <form action="#">
                            ...
                            <div class="row g-4">
                                <div class="md:w-6/12  flex-grow-0 flex-shrink-0 basis-auto custom-sm:w-6/12 ">
                                    <label for="name"
                                        class="text-sm font-heading-two text-gray-900 font-[600] mb-4">Full Name</label>
                                    <input type="text" class="common-input px-16" id="name"
                                        placeholder="Full name">
                                </div>
                                <div class="md:w-6/12  flex-grow-0 flex-shrink-0 basis-auto custom-sm:w-6/12 ">
                                    <label for="email"
                                        class="text-sm font-heading-two text-gray-900 font-[600] mb-4">Email
                                        Address</label>
                                ...
                                <div class="md:w-full flex-grow-0 flex-shrink-0 basis-auto">
                                    <label for="message"
                                        class="text-sm font-heading-two text-gray-900 font-[600] mb-4">Message</label>
                    ...
                    <div class="my-48">
                        <form action="#">
                            ...
                            <div class="flex items-start gap-16 mb-32 pb-32 border-b border-gray-100">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center gap-8">
                                        <h6 class="text-md font-[700] mb-0">Marvin McKinney</h6>
                                        <span class="w-6 h-6 bg-gray-500 rounded-[50%]"></span>
                                        <span class="text-sm font-[500] text-gray-700">26 Apr, 2024</span>
                                    </div>
                            ...
                            <div class="flex items-start gap-16 mb-32 pb-32 border-b border-gray-100">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center gap-8">
                                        <h6 class="text-md font-[700] mb-0">Kristin Watson</h6>
                                        <span class="w-6 h-6 bg-gray-500 rounded-[50%]"></span>
                                        <span class="text-sm font-[500] text-gray-700">24 Apr, 2024</span>
                                    </div>
                            ...
                            <div class="flex items-start gap-16 mb-32 pb-32 border-b border-gray-100">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center gap-8">
                                        <h6 class="text-md font-[700] mb-0">Jenny Wilson</h6>
                                        <span class="w-6 h-6 bg-gray-500 rounded-[50%]"></span>
                                        <span class="text-sm font-[500] text-gray-700">20 Apr, 2024</span>
                                    </div>
                            ...
                            <div class="flex items-start gap-16 mb-32 pb-32 border-b border-gray-100">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center gap-8">
                                        <h6 class="text-md font-[700] mb-0">Robert Fox</h6>
                                        <span class="w-6 h-6 bg-gray-500 rounded-[50%]"></span>
                                        <span class="text-sm font-[500] text-gray-700">18 Apr, 2024</span>
                                    </div>
                            ...
                            <div class="flex items-start gap-16">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center gap-8">
                                        <h6 class="text-md font-[700] mb-0">Eleanor Pena</h6>
                                        <span class="w-6 h-6 bg-gray-500 rounded-[50%]"></span>
                                        <span class="text-sm font-[500] text-gray-700">7 Apr, 2024</span>
                                    </div>
                                    <p class="mt-16 text-gray-700">Nulla molestie interdum ultricies. </p>
                                </div>
                            </div>
                            <div class="mt-48">
                                <button type="submit" class="btn btn-main py-13 flex items-center gap-8">
                ...
                <div class="xl:w-4/12  flex-grow-0 flex-shrink-0 basis-auto ps-xl-4">
                    <!-- Search Start -->
                    <div class="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
                        <h6 class="text-xl mb-32 pb-32 border-b border-gray-100">Search Here</h6>
                        <form action="#">
                            <div class="input-group relative flex flex-wrap items-stretch w-full">
                                <input type="text"
                                    class="form-control block w-full  p-[0.375rem_0.75rem] text-base leading-6 text-[#495057] bg-white bg-clip-padding border border-[#ced4da] rounded transition-all duration-150 ease-in-out focus:text-[#495057] focus:bg-white focus:border-main focus:outline-0 focus:shadow-none common-input bg-color-three"
                                    placeholder="Searching...">
                                <button type="submit"
                                    class="btn btn-main h-56 w-56 flex items-center justify-center text-2xl input-group relative flex flex-wrap items-stretch w-full-text"><i
                    ...
                    <!-- Recent Post Start -->
                    <div class="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
                        <h6 class="text-xl mb-32 pb-32 border-b border-gray-100">Recent Posts</h6>
                        ...
                        <ul>
                            <li class="mb-16">
                                <a href="blog-details.html"
                                    ...
                                    <span>Gaming (12)</span>
                                    <span
                                        class="w-40 h-40 flex items-center justify-center rounded-4 bg-main-50 text-main-600"><i
