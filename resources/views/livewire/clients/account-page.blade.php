                ...
                <div class="row g-4">
                    ...
                    <div class="2xl:w-6/12  flex-grow-0 flex-shrink-0 basis-auto pe-xl-5">
                        <div class="border border-gray-100 hover-border-main-600 transition-1 rounded-16 px-24 py-40 h-full">
                            ...
                            <div class="mb-24">
                                <label for="username" class="text-neutral-900 text-lg mb-8 font-[500]">Username or email
                                    address <span class="text-danger">*</span> </label>
                                <input type="text" class="common-input" id="username" placeholder="First Name">
                            </div>
                            <div class="mb-24">
                                <label for="password" class="text-neutral-900 text-lg mb-8 font-[500]">Password</label>
                                <div class="relative">
                            ...
                            <div class="mb-24 mt-48">
                                <div class="flex items-center gap-48 flex-wrap">
                                    ...
                                    <div class="form-check common-check">
                                        ...
                                        <label class="form-check-label flex-grow" for="remember">Remember me</label>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-48">
                                <a href="index.html"
                                    class="text-danger-600 text-sm font-[600] hover-text-decoration-underline">Forgot your
                                    password?</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="2xl:w-6/12  flex-grow-0 flex-shrink-0 basis-auto">
                        <div class="border border-gray-100 hover-border-main-600 transition-1 rounded-16 px-24 py-40">
                            ...
                            <div class="mb-24">
                                <label for="usernameTwo" class="text-neutral-900 text-lg mb-8 font-[500]">Username <span
                                        class="text-danger">*</span> </label>
                                <input type="text" class="common-input" id="usernameTwo" placeholder="Write a username">
                            </div>
                            <div class="mb-24">
                                <label for="emailTwo" class="text-neutral-900 text-lg mb-8 font-[500]">Email address <span
                                        class="text-danger">*</span> </label>
                                <input type="email" class="common-input" id="emailTwo" placeholder="Enter Email Address">
                            </div>
                            <div class="mb-24">
                                <label for="enter-password" class="text-neutral-900 text-lg mb-8 font-[500]">Password <span
                                        class="text-danger">*</span></label>
                                <div class="relative">
                            ...
                            <div class="my-48">
                                <p class="text-gray-500">Your personal data will be used to process your order, support your
                                    ...
                                    <a href="index.html" class="text-main-600 text-decoration-underline"> privacy policy</a>
                                    .
                                </p>
                            </div>
                            <div class="mt-48">
